...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ref={ref}
      id={props.id || "kitchen-sidebar-input"}
      name={props.name || "kitchenSidebarInput"}

...
function CustomerLoginPortal() {
  ...
  // Animation Variants for Page, Logo, Glass Panel, and Staggered Form
            ...
            <div>
              ...
              <AnimatePresence mode="wait">
                {mode === "customer" ? (
                  ...
                  >
                    {/* Full Name Field (Item 2 - Glass Input Control) */}
                    ...
                    {/* Phone Field (Item 3 - Glass Input Control) */}
                    <motion.div variants={itemVariants}>
                    ...
                    {/* Email Field (Item 4 - Glass Input Control) */}
                    <motion.div variants={itemVariants}>
                    ...
                    {/* Start Ordering Button (Item 5 - Shimmer Glass CTA) */}

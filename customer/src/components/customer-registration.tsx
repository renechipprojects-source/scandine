    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full h-28 sm:h-32 rounded-2xl overflow-hidden mb-3.5 border border-border/60 shadow-xs flex flex-col items-center justify-center text-center p-3"
        >
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="w-full flex-1 flex flex-col justify-between">
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <motion.div variants={itemVariants}>
              <label htmlFor="reg-name" className="text-[10px] font-bold uppercase tracking-wider text-foreground/80 block mb-1">
            ...
            <motion.div variants={itemVariants}>
              <label htmlFor="reg-phone" className="text-[10px] font-bold uppercase tracking-wider text-foreground/80 block mb-1">
            ...
            <motion.div variants={itemVariants}>
              <label htmlFor="reg-email" className="text-[10px] font-bold uppercase tracking-wider text-foreground/80 block mb-1">
